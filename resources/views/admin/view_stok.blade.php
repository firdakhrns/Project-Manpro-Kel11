...
<head>
    ...
    <title>Pencatatan Stok Admin</title>
...
<body class="flex items-start justify-center min-h-screen p-4">
    <div class="bg-white p-6 md:p-10 rounded-2xl shadow-xl container">
        ...
        <div class="header-content pt-10">
            <h1 class="text-3xl md:text-4xl font-extrabold text-center mb-2">Pencatatan Stok Admin</h1>
...
@endif
        ...
        <form id="stockFormAdmin" action="{{ route('admin.view_stok.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-x-10 gap-y-6">
                ...
                <div id="kartu-perdana-section" class="category-section" data-product-type="kartu-perdana">
                    ...
                    <div class="space-y-4">
                        <div class="input-group">
                            <label for="kp_3gb">3 GB</label>
                            <input type="number" id="kp_3gb" name="stok[kp][3gb]" placeholder="Masukkan jumlah" min="0" value="0">
                        </div>
                        <div class="input-group">
                            <label for="kp_6gb">6 GB</label>
                            <input type="number" id="kp_6gb" name="stok[kp][6gb]" placeholder="Masukkan jumlah" min="0" value="0">
                        </div>
                        <div class="input-group">
                            <label for="kp_9gb">9 GB</label>
                            <input type="number" id="kp_9gb" name="stok[kp][9gb]" placeholder="Masukkan jumlah" min="0" value="0">
                        </div>
                         <div class="input-group">
                            <label for="kp_20gb">20 GB</label>
                            <input type="number" id="kp_20gb" name="stok[kp][20gb]" placeholder="Masukkan jumlah" min="0" value="0">
                        </div>
                    </div>
                </div>
