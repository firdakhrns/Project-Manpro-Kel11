...
<head>
    ...
    <title>Monitoring Stok Regional</title>
    ...
    <style>
        ...
        .pivot-table th { background-color: var(--im3-red); color: white; font-weight: 700; font-size: 0.85rem; padding: 10px 12px; border: 1px solid #e2e8f0; }
    ...
    <div class="container-card w-full">
        ...
        <div class="table-wrapper">
            <table class="pivot-table">
                ...
                <tbody>
                    {{-- Loop data yang sudah di-pivot di Controller ($pivotDataStok) --}}
