...
<head>
    ...
    <style>
        ...
        .header { background-color: #E21B21; color: white; padding: 15px; text-align: center; margin-bottom: 20px; }
        .header h1 { margin: 0; font-size: 20px; }
        .content { padding: 0 20px; }
        .section-header { border-bottom: 2px solid #FFDA00; padding-bottom: 5px; margin-top: 20px; margin-bottom: 10px; font-size: 16px; font-weight: bold; color: #444; }
