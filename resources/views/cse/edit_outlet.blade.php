...
<body class="flex items-center justify-center min-h-screen p-4">
    <div class="container-card w-full">
        ...
        <form method="POST" action="{{ route('cse.outlet.update', $outlet->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')

            {{-- BLOK VALIDASI DARI CONTROLLER (JIKA UPDATE GAGAL) --}}
            @if ($errors->any())
