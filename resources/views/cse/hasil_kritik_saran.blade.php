                ...
                <tbody>
                    @forelse($feedbackData ?? [] as $feedback)
                        <tr>
                            ...
                            <td>
                                {{ $feedback->dse_target }}
                                @if($feedback->dseTarget)
                                    <br><small class="text-gray-500">{{ $feedback->dseTarget->name }}</small>
                                @endif
                            </td>
                            <td>
                                <span class="px-3 py-1 text-xs font-semibold rounded-full 
                                    {{ strtolower($feedback->type) == 'kritik' ? 'bg-red-100 text-red-800' : 'bg-yellow-100 text-yellow-800' }}">
