...
<head>
    ...
    <style>
        ...
        /* Tabel Performa Styling */
        .performa-table { width: 100%; border-collapse: collapse; margin-top: 20px; }
        ...
        .rate-low { color: #065f46; font-weight: 700; } /* Retur rendah (Baik) */
        .rate-high { color: #991b1b; font-weight: 700; } /* Retur tinggi (Buruk) */
...
<body class="flex items-start justify-center min-h-screen pt-10 pb-10">
    <div class="container-card w-full">
        ...
        <p class="text-gray-500 text-center mb-8">Evaluasi Berdasarkan Rasio Retur (Return Rate) Regional</p>

        {{-- FORM FILTER PERIODE --}}
        <form method="GET" action="{{ route('cse.view_performa') }}" class="mb-8 p-6 border rounded-lg bg-gray-100">
            <h2 class="text-xl font-bold mb-4 text-gray-700">Filter Periode: {{ $userRegion ?? 'Regional' }}</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="metric-card">
                ...
                <p class="text-sm text-gray-600 mt-1">Idealnya mendekati 0%</p>
            </div>
