...
<head>
    ...
    <title>Pencatatan Stok DSE</title>
    ...
    <style>
        ...
        .back-button {
            ...
            left: 20px;
            transform: translate(0, 0); /* Hapus translate untuk posisi menjorok */
            z-index: 11;
        }
...
@endif
        ...
        <form action="{{ route('dse.input_stok.store') }}" method="POST">
            @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        @foreach($kp_products as $product)
                            ...
                            <div class="input-group">
                                <label for="kp_{{ $name }}">{{ $product }}</label>
                                <input type="number" id="kp_{{ $name }}" name="stok[kp][{{ $name }}]" placeholder="Masukkan jumlah" min="0" value="0">
                            </div>
                        @endforeach
                    </div>
                </div>
